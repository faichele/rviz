#include "ogre_sg_technique_resolver_listener.h"

#include "OgreTechnique.h"

OgreSGTechniqueResolverListener::OgreSGTechniqueResolverListener(Ogre::RTShader::ShaderGenerator *pShaderGenerator)
{
